...
class Direction(Enum):
    """
    Setting up direction : Right, Left, Up, Down
    """
    RIGHT = 1
    LEFT = 2
    UP = 3
...
class SnakeGameAI:
    """
    Make the logic to teach the AI playing Snake
    """
    ...
    def _place_food(self):
        """
        Place the location of food randomly in the game environment  
        """

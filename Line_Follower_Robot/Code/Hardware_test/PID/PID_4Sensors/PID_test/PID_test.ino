...
void loop() {
  ...
  analogWrite(ENB, 0.8*initial_motor_speed); //Right Motor Speed
  forward();
    }
    else {
       calculate_pid();
...
void motor_control()
{
  ...
  left_motor_speed = constrain(left_motor_speed, 63, 150);
  right_motor_speed = constrain(right_motor_speed, 50, 150);

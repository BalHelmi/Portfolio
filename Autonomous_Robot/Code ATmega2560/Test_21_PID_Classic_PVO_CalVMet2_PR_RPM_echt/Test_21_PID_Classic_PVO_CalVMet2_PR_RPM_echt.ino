...
void PIDvitesseR() {
    /*if (vitesseRcmd-vitesseRact>pwmRmax)
      ...
      pwmR=pwmRmin;*/
    sommeVRerror+=(double) VRerror / (2 * dtR);
    dVRerror=(double) (VRerror - prevVRerror) / dtR;
    prevVRerror = VRerror;
...
void PIDvitesseL() {
    /*if (vitesseLcmd-vitesseLact>pwmLmax)
      ...
      pwmL=pwmLmin;*/
    sommeVLerror+=(double) VLerror / (2 * dtL);
    dVLerror=(double) (VLerror - prevVLerror) / dtL;
    prevVLerror = VLerror;
